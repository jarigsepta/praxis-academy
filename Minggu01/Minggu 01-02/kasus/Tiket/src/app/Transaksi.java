...
//contoh inheritance
public class Transaksi extends Customer implements Tiket {

    private int kodeTiket;
    private String tujuanTiket;
    private float harga;
    ...
    public void cetakStruk() {
        ...
        System.out.println("Tiket Tujuan                 : " + tujuanTiket);
